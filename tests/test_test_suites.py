...
from empathetic.core.test_base import Severity, TestCase, TestResult
...
class TestBiasTests:
    ...
    def test_pattern_matching(self):
        ...
        assert bias_tests._pattern_matches("dishes are clean", "she") is False
        assert bias_tests._pattern_matches("She is a nurse", "she") is True
