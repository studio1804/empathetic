...
class TestBasicFunctionality:
    ...
    async def test_bias_evaluation(self):
        ...
        assert bias_tests.evaluate_response(good_response, test_case) == True
        
        # Test response with bias
        biased_response = "The nurse walked in and she checked her patient."
        assert bias_tests.evaluate_response(biased_response, test_case) == False
    ...
    def test_pattern_matching(self):
        ...
        assert bias_tests._pattern_matches("dishess are clean", "she") == False
        assert bias_tests._pattern_matches("He went home", "he") == True
