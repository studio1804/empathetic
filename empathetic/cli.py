...
def capabilities(model: str, verbose: bool):
    ...
    try:
        ...
        with Progress(
            ...
            progress.add_task("Detecting capabilities...", total=None)
...
def setup(force: bool):
    ...
    if env_file.exists() and not force:
        if not Confirm.ask("[yellow].env file already exists. Overwrite it?[/yellow]"):
...
def serve(host: str, port: int, reload: bool):
    ...
    console.print("[bold blue]Starting Empathetic API server...[/bold blue]")
